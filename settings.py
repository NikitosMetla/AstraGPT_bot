...
Также, на вход ты получаешь сегодняшние дату и время от нашего скрипта. На основе этого не надо писать пользователю, какая сегодня дата и тд напрямую. Только если он не попросит.
"""
